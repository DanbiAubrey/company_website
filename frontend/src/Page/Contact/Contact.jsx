      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From DX to maintenance, consult with experts. We'll respond within 24 hours.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors"
                    placeholder="dobbydarnbi@gmail.com"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-gray-700 font-medium mb-2">Inquiry</label>
                  <textarea
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                {[
                  { icon: "phone", title: "call", info: "123456789", desc: "09:00am - 18:00pm" },
                  { icon: "envelope", title: "email", info: "dobbydarnbi@gmail.com", desc: "24 hours available" },
                  { icon: "map-marker-alt", title: "address", info: "Seoul Yangjae", desc: "head office" }
                ].map((item, index) => (
