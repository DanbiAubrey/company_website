        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {dummyPosts.length === 0 ? (
            ...
            dummyPosts.map((post) => (
              <div
                key={post._id}
                className="border-b border-gray-100 last:border-b-0 hover:bg-red-50 transition-colors duration-300"
              >
                <div className="p-6 flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 hover:text-red-600 transition-colors duration-300">
                      {post.title}
                    </h3>
